      ...
      <div  className="container bg-[#FFFFFF0F] py-10">
        ...
        <div>
          <ul className="flex flex-wrap justify-center items-center gap-5 my-8 lg:text-lg text-sm cursor-pointer text-white">
            <li className="py-2 px-5  bg-[#09152E] rounded-md hover:bg-[#297BB2]">
              All
            </li>
            <li className="py-2 px-5 bg-[#09152E] rounded-md hover:bg-[#297BB2]">
              Fullstack
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
          {projects.map((project, i) => (
            <div
              key={i}
              className="text-white mx-auto py-10 px-6 bg-[#151A25] rounded-xl w-full"
            >
              ...
              {project.technology && (
                <div className="px-4 py-2 my-3 rounded-md bg-[#FFFFFF0F] flex flex-wrap justify-start gap-2">
                  {project.technology.map((tech) => (
                    <p className="px-2 rounded border border-[#23a0f3] text-[#139df8] text-sm">
                      {tech}
                    </p>
                  ))}
                </div>
