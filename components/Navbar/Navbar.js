    ...
    <>
      {
        ...
        <div
          className={`${dark ? "bg-[#151A25]" : "bg-white"
          ...
          >
            ...
            <div className="flex justify-end gap-10 items-center">
              <div>
                <ul
                  className={`${dark ? "bg-[#151A25]" : "bg-white"
                    } z-[999] lg:w-full w-[250px] lg:p-0 py-10 rounded  text-lg flex lg:flex-row flex-col text-center items-center lg:gap-10 gap-6 md:static absolute ${open ? "top-16 left-0 duration-500" : "left-[-900px]"
                    }`}
                >
